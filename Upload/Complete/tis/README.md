...
Creates a list of all the available Artifacts located on the T-Drive Fallback directory. Has subclasses for each LCO version. New LCO versions can be easily added using this the same workflow.
